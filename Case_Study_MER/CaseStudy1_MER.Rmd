...
<!--
Create loop to test for all similarities and append a table with those cases

namestotest = tolower(namestotest)
agrep(namestotest[2],namestotest[-2],ignore.case=T,value=T,max.distance = 0.1, useBytes = FALSE)
-->
