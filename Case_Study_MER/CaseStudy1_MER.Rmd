...
duptable = data.frame(Index=as.numeric(),Name=as.character(),City=as.character(),State=as.character())
...
dupoccurance = data.frame(Index=i,Name = name, City=Breweries[i,3],State=Breweries[i,4])
...
duptable = duptable[with(duptable, order(Name, City)),]
